 ...
 * 1. Server Component (this file) allows route segment config (dynamic, revalidate)
 * 2. Client Component (ClientApp) handles the React Router SPA
 * 3. React Router DOM manages all client-side routing
 * 
